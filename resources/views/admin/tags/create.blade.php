...
@section('page-title', 'Créer un tag')
        ...
        <div style="max-width: 700px; margin: 0 auto;">
            <div class="card" style="padding: 2rem;">
                ...
                <p style="color: #64748b; margin-bottom: 2rem;">
                    Ajoutez un nouveau tag pour catégoriser les tutoriels
                </p>
                ...
                <form action="{{ route('admin.tags.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name"
                            class="form-control @error('name') has-error @enderror" value="{{ old('name') }}" required
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="family" name="family" list="family-list"
                            class="form-control @error('family') has-error @enderror" value="{{ old('family') }}" required
