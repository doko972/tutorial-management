            ...
            <div class="card" style="padding: 2rem;">
                ...
                <form action="{{ route('admin.branches.update', $branch) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <span class="form-text">Laissez vide pour une branche principale, ou sélectionnez une branche
                            parente</span>
                        @error('parent_id')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; gap: 1rem; align-items: center;">
                            <input type="color" id="color" name="color" value="{{ old('color', $branch->color) }}" required
