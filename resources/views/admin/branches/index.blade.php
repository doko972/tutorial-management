...
<div class="dashboard-section">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(300px, 1fr)); gap: 1.5rem;">
        ...
        <div class="card" style="border-top: 4px solid {{ $branch->color }};">
            ...
            <!-- Statistiques -->
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; padding: 1rem; background: #f8fafc; border-radius: 0.5rem; margin-bottom: 1rem;">
            ...
            <div style="display: flex; gap: 0.5rem; padding-top: 1rem; border-top: 1px solid #e2e8f0;">
                ...
                <form action="{{ route('admin.branches.destroy', $branch) }}" method="POST" style="flex: 1;" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cette branche ? Cette action est irréversible.');">
                    @csrf
                    @method('DELETE')
