                ...
                <div>
                    <div class="card" style="padding: 2rem;">
                        ...
                        <div style="margin-bottom: 2rem; padding-bottom: 2rem; border-bottom: 1px solid #e2e8f0;">
                            <!-- Badge branche -->
                            <div
                                style="display: inline-block; padding: 0.25rem 0.75rem; background: {{ $tutorial->branch->color }}20; color: {{ $tutorial->branch->color }}; border-radius: 0.375rem; font-size: 0.75rem; font-weight: 600; margin-bottom: 1rem;">
                                {{ $tutorial->branch->name }}
                            </div>
                        ...
                        @if ($tutorial->description)
                            <div
                                style="margin-bottom: 2rem; padding: 1.5rem; background: #f8fafc; border-radius: 0.75rem; border-left: 4px solid {{ $tutorial->branch->color }};">
                    ...
                    @can('update', $tutorial)
                        <div class="card" style="margin-bottom: 1.5rem; padding: 1.5rem;">
                            ...
                            <div style="display: flex; flex-direction: column; gap: 0.75rem;">
                                ...
                                <form action="{{ route('my-tutorials.destroy', $tutorial) }}" method="POST"
                            ...
                            <div style="display: flex; flex-direction: column; gap: 1rem;">
                                @foreach ($relatedTutorials as $related)
                                    <a href="{{ route('tutorials.show', $related) }}"
                                        ...
                                        <h4
                                            style="font-size: 0.875rem; font-weight: 600; color: #0f172a; margin-bottom: 0.5rem;">
                                            {{ $related->title }}</h4>
                                        <p style="font-size: 0.75rem; color: #64748b; margin: 0;">
                                            {{ $related->author->name }} • {{ $related->views_count }} vue(s)</p>
                                    </a>
                                @endforeach
                            </div>
                        </div>
